...
import { TabsDemo } from "@/components/Parallax";
...
export default function Home() {
  ...
  return (
    <div className="flex-col">
          ...
          <>
            <h1 className="text-4xl font-semibold text-black dark:text-white">
              ...
              <span className="text-4xl md:text-[6rem] font-bold mt-1 leading-none">
                Trading and Swapping with TradeMate
              </span>
            </h1>
          </>
        }
      ...
      <TabsDemo/>
      <footer className="text-gray-500 bg-black px-10 py-5 max-w-screen-xl mx-auto md:px-7">
            <div className="max-w-lg sm:mx-auto sm:text-center">
                <img src="logo.png" className="w-32 sm:mx-auto" />
                <p className="leading-relaxed mt-2 text-[15px]">
                Trade smarter with TradeMate: Your Telegram Trading Partner!
                </p>
            </div>

            <div className="mt-8 items-center justify-between sm:flex">
                <div className="mt-4 sm:mt-0">
                    &copy; 2024 TradeMate All rights reserved.
                </div>
